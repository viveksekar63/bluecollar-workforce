...
export default function RootLayout() {
  ...
  return <><StatusBar style="dark" /><Stack screenOptions={{ headerShown: false, animation: 'slide_from_right', contentStyle: { backgroundColor: BrandColors.background } }}>
    ...
    <Stack.Screen name="privacy-policy" /><Stack.Screen name="disclaimer" /><Stack.Screen name="profile" /><Stack.Screen name="address" /><Stack.Screen name="home" /><Stack.Screen name="skills" /><Stack.Screen name="profession" /><Stack.Screen name="experience" /><Stack.Screen name="verification" /><Stack.Screen name="documents" /><Stack.Screen name="explore" /><Stack.Screen name="job-details" />
