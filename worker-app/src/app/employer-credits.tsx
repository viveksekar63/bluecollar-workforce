    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      <View style={styles.topHeader}>
        ...
        <View style={styles.headerIcon}>
          <CreditIcon size={25} color={BrandColors.indigo} />
        </View>
      </View>
      ...
      <View style={styles.hero}>
        ...
        <View style={styles.heroTopRow}>
          <View style={styles.heroIconCircle}>
            <CreditIcon size={25} color={BrandColors.white} />
          </View>
      ...
      <View style={styles.trustRow}>
        ...
        <TrustItem icon="wallet" title="Simple" subtitle="1 credit per contact" />
        <View style={styles.trustDivider} />
      ...
      {packages.map((p, index) => {
        ...
        const variant = p.code === 'STARTER' ? 'starter' : p.code === 'GROWTH' ? 'growth' : 'business';
        ...
        return <View key={p.code} style={[styles.package, popular && styles.packagePopular]}>
          ...
          <View style={styles.packageTop}>
            <View style={[styles.packageIcon, popular && styles.packageIconPopular]}>
              <CreditIcon variant={variant} size={25} color={popular ? BrandColors.white : BrandColors.indigo} />
            </View>
      ...
      <Pressable style={styles.historyCard} onPress={() => router.push('/credit-history')}>
        <View style={styles.historyIcon}><CreditIcon size={21} color={BrandColors.indigo} /></View>
...
function TrustItem({ icon, title, subtitle }: { icon: string; title: string; subtitle: string }) {
  return <View style={styles.trustItem}>
    <View style={styles.trustIcon}>
      {icon === 'wallet' ? <CreditIcon size={17} color={BrandColors.indigo} /> : <Text style={styles.trustIconText}>{icon}</Text>}
    </View>
...
const styles = StyleSheet.create({
  ...
  sectionCopy: { flex: 1, paddingRight: 8 },
